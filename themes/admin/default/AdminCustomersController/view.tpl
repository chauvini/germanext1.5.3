			...
			<div>
				...
				{if !$customer_exists}
					<form method="POST" action="index.php?tab=AdminCustomers&id_customer={$customer->id}&token={getAdminToken tab='AdminCustomers'}">
						...
						<p class="center"><input class="button" type="submit" name="submitGuestToCustomer" value="{l s='Transform to customer account' mod='germanext'}" /></p>
						{l s='This feature generates a random password and sends an e-mail to the customer' mod='germanext'}
					</form>
				{else}
					</div><div><b style="color:red;">{l s='A registered customer account already exists with this e-mail address' mod='germanext'}</b>
				{/if}
			</div>
		{/if}
...
<div class="clear"></div>
	...
	<div>
		...
		<p>{l s='This note will be displayed to all employees but not to the customer.' mod='germanext'}</p>
	...
	{if count($messages)}
		...
		<div class="clear">&nbsp;</div>
	{else}
		{$customer->firstname} {$customer->lastname} {l s='has never contacted you' mod='germanext'}
	{/if}
	...
	<h2>{l s='Groups' mod='germanext'} ({count($groups)})</h2>
	{if $groups AND count($groups)}
		<table cellspacing="0" cellpadding="0" class="table" style="width:100%;">
			...
			<tr>
				<th height="39px" class="right">{l s='ID' mod='germanext'}</th>
			...
			<div>
				...
				<table cellspacing="0" cellpadding="0" class="table" style="width:100%; text-align:left;">
					...
					<tr>
						...
						<th class="left">{l s='Products' mod='germanext'}</th>
						<th class="left">{l s='Total spent' mod='germanext'}</th>
						<th class="center">{l s='Actions' mod='germanext'}</th>
					</tr>
			...
			<div>
				...
				<table cellspacing="0" cellpadding="0" class="table" style="width:100%;">
					...
					<tr>
						...
						<th class="center">{l s='Payment' mod='germanext'}</th>
						<th class="center">{l s='State' mod='germanext'}</th>
						<th class="center">{l s='Products' mod='germanext'}</th>
						<th class="center">{l s='Total spent' mod='germanext'}</th>
						<th class="center">{l s='Actions' mod='germanext'}</th>
					</tr>
