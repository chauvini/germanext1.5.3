...
<div id="step1">
	...
	<div>
		...
		<label class="radioCheck" for="virtual_product">{l s='Virtual Product (services, booking and downloadable products)' mod='germanext'}</label>
	</div>
...
<table cellpadding="5" cellspacing="0" border="0" style="width: 100%;"><tr><td><div class="separation"></div></td></tr></table>
		<table cellspacing="0" cellpadding="5" border="0">
			<tr>
				<td class="col-left"><label>{l s='Short description:' mod='germanext'}<br /></label><p class="product_description">({l s='appears in the product lists and on the top of the product page' mod='germanext'})</p></td>
				<td style="padding-bottom:5px;">
