...
<table>
	<tr>
		...
		<td style="padding-bottom:5px;">
			...
			<p class="preference_description">{l s='The wholesale price at which you bought this product' mod='germanext'}</p>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="on_sale" id="on_sale" style="padding-top: 5px;" {if $product->on_sale}checked="checked"{/if} value="1" />&nbsp;<label for="on_sale" class="t">{l s='Display "on sale" icon on product page and text on product listing' mod='germanext'}</label>
		</td>
	</tr>
	<tr>
