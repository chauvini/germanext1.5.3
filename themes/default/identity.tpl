...
{if isset($confirmation) && $confirmation}
	<p class="success">
		...
		{if isset($pwd_changed)}<br />{l s='Your password has been sent to your e-mail:' mod='germanext'} {$email|escape:'htmlall':'UTF-8'}{/if}
	</p>
{else}
	...
	<form action="{$link->getPageLink('identity', true)}" method="post" class="std">
		<fieldset>
			...
			<p id="security_informations">
				{l s='[Insert customer data privacy clause or law here, if applicable]' mod='germanext'}
			</p>
		</fieldset>
	</form>
{/if}
