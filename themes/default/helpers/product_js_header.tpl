...
// Translations
var doesntExist = '{l s='This combination does not exist for this product. Please choose another.' mod='germanext' js=1}';
...
var uploading_in_progress = '{l s='Uploading in progress, please wait...' mod='germanext' js=1}';
var fieldRequired = '{l s='Please fill in all required fields, then save the customization.' mod='germanext' js=1}';
{if isset($groups)}
	// Combinations
