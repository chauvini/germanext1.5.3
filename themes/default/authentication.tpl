...
<h1>{if !isset($email_create)}{l s='Log in' mod='germanext'}{else}{l s='Create your account' mod='germanext'}{/if}</h1>
...
{if !isset($email_create)}
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form" class="std">
		<fieldset>
			<h3>{l s='Create your account' mod='germanext'}</h3>
			<div class="form_content clearfix">
				<p class="title_block">{l s='Enter your e-mail address to create an account' mod='germanext'}.</p>
				<p class="text">
				...
				<p class="submit">
					...
					<input type="button" id="SubmitCreate" name="SubmitCreate" class="button_large" value="{l s='Create your account' mod='germanext'}" />
					<input type="hidden" class="hidden" name="SubmitCreate" value="{l s='Create your account' mod='germanext'}" />
				</p>
			</div>
		</fieldset>
	</form>
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div class="form_content clearfix">
				<p class="text">
					<label for="email">{l s='E-mail address' mod='germanext'}</label>
		...
		<fieldset>
			...
			<div id="opc_account_form" style="display: block; ">
				...
				<p class="required text">
					<label for="guest_email">{l s='E-mail address' mod='germanext'} <sup>*</sup></label>
		...
		{foreach from=$dlv_all_fields item=field_name}
			...
			{elseif $field_name eq "address1"}
				<p class="required text">
					<label for="address1">{l s='Address' mod='germanext'} <sup>*</sup></label>
					<input type="text" class="text" name="address1" id="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{/if}" />
					<span class="inline-infos">{l s='Street address, P.O. box, company name, c/o' mod='germanext'}</span>
				</p>
