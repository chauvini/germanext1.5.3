			...
			'general' => array(
				...
				'fields' =>	array(
                    ...
                    'PS_CONDITIONS' => array(
                        ...
                        'desc' => $this->l('Require customers to accept or decline terms of service and revocation before processing the order'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'type' => 'bool',
                    ),
                    'PS_CMS_ID_CONDITIONS' => array(
                        'title' => $this->l('Conditions of use terms and conditions CMS page'),
                        'desc' => $this->l('Choose the Conditions of use terms and conditions CMS page'),
                        'validation' => 'isInt',
                        'type' => 'select',
                        'list' => $cms_tab,
                        'identifier' => 'id',
